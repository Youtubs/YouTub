...
if text and text:match("^تغير الاشتراك$") and Sudo_bot_id(msg) then  
redis:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '܁༯┆حسنا ارسل المعرف الان 💞 ܰ') 
return false  
end
if text and text:match("^وضع قناة الاشتراك$") and Sudo_bot_id(msg) then  
redis:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '܁༯┆ارسل معرف قناتك 💞 ܰ') 
return false  
end
if text == "تفعيل الاشتراك" and Sudo_bot_id(msg) then  
if redis:get(bot_id..'add:ch:id') then
